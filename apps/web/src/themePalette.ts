...
const RESERVED_THEME_IDS = new Set([...SHARED_RESERVED_THEME_IDS, CRYSTL_THEME_ID]);
...
export function isKnownThemePreference(theme: string): boolean {
  if (theme === "light" || theme === "dark" || theme === "system" || theme === "crystl") {
    return true;
  }
